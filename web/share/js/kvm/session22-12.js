...
export function Session() {
	...
	var __hid2 = new Hid2(__streamer2.getGeometry, __recorder);
	var __atx = new Atx(__recorder);
	var __atx2 = new Atx2(__recorder);
	var __msd = new Msd();
	...
	var __wsMessageHandler = function(event) {
		...
		switch (data.event_type) {
			...
			case "hid_keymaps_state": __hid.setKeymaps(data.event);__hid2.setKeymaps(data.event); break;
			case "hid_state": __hid.setState(data.event);__hid2.setState(data.event); break;
			case "atx_state": __atx.setState(data.event); __atx2.setState(data.event);break;
			case "msd_state": __msd.setState(data.event); break;
			case "streamer_state": __streamer.setState(data.event);__streamer2.setState(data.event); break;
