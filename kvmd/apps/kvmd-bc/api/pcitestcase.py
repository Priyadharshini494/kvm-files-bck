...
class PciApi:
    ...
    @exposed_http('GET' , '/enumerate_device')
    ...
    @exposed_http('GET', '/check_driver_info')
    ...
    @exposed_http('GET', '/error_handling')
    ...
    @exposed_http('GET', '/power_management')
    ...
    @exposed_http('GET', '/baseboard_info')
    ...
    @exposed_http('GET', '/check_configuration_space')
    ...
    @exposed_http('GET','/check_configuration_space_segment')
