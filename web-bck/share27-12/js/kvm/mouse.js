...
export function Mouse2(__getResolution, __recordWsEvent) {
	var self = this;
	...
	var __init__ = function() {
		...
		$("stream-box2").onwheel = __streamWheelHandler;
		$("stream-box2").ontouchstart = (event) => __streamTouchMoveHandler(event);

		tools.storage.bindSimpleSwitch($("hid-mouse-squash-switch2"), "hid.mouse.squash", true);
		tools.slider.setParams($("hid-mouse-sens-slider2"), 0.1, 1.9, 0.1, tools.storage.get("hid.mouse.sens", 1.0), __updateRelativeSens);
		tools.slider.setParams($("hid-mouse-rate-slider2"), 10, 100, 10, tools.storage.get("hid.mouse.rate", 100), __updateRate); // set __timer
	};
	...
	var __updateRate = function(value) {
		$("hid-mouse-rate-value2").innerHTML = value;
		tools.storage.set("hid.mouse.rate", value);
		if (__timer) {
			clearInterval(__timer);
		}
	...
	var __updateRelativeSens = function(value) {
		$("hid-mouse-sens-value2").innerHTML = value.toFixed(1);
		tools.storage.set("hid.mouse.sens", value);
		__relative_sens = value;
	};
	...
	var __isRelativeCaptured = function() {
		return (document.pointerLockElement === $("stream-box2"));
	};

	var __isRelativeSquashed = function() {
		return $("hid-mouse-squash-switch2").checked;
	};
...
export function Mouse3(__getResolution, __recordWsEvent) {
	var self = this;
	...
	var __init__ = function() {
		...
		$("stream-box3").onwheel = __streamWheelHandler;
		$("stream-box3").ontouchstart = (event) => __streamTouchMoveHandler(event);

		tools.storage.bindSimpleSwitch($("hid-mouse-squash-switch3"), "hid.mouse.squash", true);
		tools.slider.setParams($("hid-mouse-sens-slider3"), 0.1, 1.9, 0.1, tools.storage.get("hid.mouse.sens", 1.0), __updateRelativeSens);
		tools.slider.setParams($("hid-mouse-rate-slider3"), 10, 100, 10, tools.storage.get("hid.mouse.rate", 100), __updateRate); // set __timer
	};
	...
	var __updateRate = function(value) {
		$("hid-mouse-rate-value3").innerHTML = value;
		tools.storage.set("hid.mouse.rate", value);
		if (__timer) {
			clearInterval(__timer);
		}
	...
	var __updateRelativeSens = function(value) {
		$("hid-mouse-sens-value3").innerHTML = value.toFixed(1);
		tools.storage.set("hid.mouse.sens", value);
		__relative_sens = value;
	};
	...
	var __isRelativeCaptured = function() {
		return (document.pointerLockElement === $("stream-box3"));
	};

	var __isRelativeSquashed = function() {
		return $("hid-mouse-squash-switch3").checked;
	};
...
export function Mouse4(__getResolution, __recordWsEvent) {
	var self = this;
	...
	var __init__ = function() {
		...
		$("stream-box4").onwheel = __streamWheelHandler;
		$("stream-box4").ontouchstart = (event) => __streamTouchMoveHandler(event);

		tools.storage.bindSimpleSwitch($("hid-mouse-squash-switch4"), "hid.mouse.squash", true);
		tools.slider.setParams($("hid-mouse-sens-slider4"), 0.1, 1.9, 0.1, tools.storage.get("hid.mouse.sens", 1.0), __updateRelativeSens);
		tools.slider.setParams($("hid-mouse-rate-slider4"), 10, 100, 10, tools.storage.get("hid.mouse.rate", 100), __updateRate); // set __timer
	};
	...
	var __updateRate = function(value) {
		$("hid-mouse-rate-value4").innerHTML = value;
		tools.storage.set("hid.mouse.rate", value);
		if (__timer) {
			clearInterval(__timer);
		}
	...
	var __updateRelativeSens = function(value) {
		$("hid-mouse-sens-value4").innerHTML = value.toFixed(1);
		tools.storage.set("hid.mouse.sens", value);
		__relative_sens = value;
	};
	...
	var __isRelativeCaptured = function() {
		return (document.pointerLockElement === $("stream-box4"));
	};

	var __isRelativeSquashed = function() {
		return $("hid-mouse-squash-switch4").checked;
	};
