...
class PciApi:
    ...
    async def enumerate_device_logic(self, os, location):
    ...
    async def pci_description_filter_logic(self, os, location):
    ...
    async def check_driver_info_logic(self, os, location):
    ...
    async def error_handling_logic(self, os, location):
    ...
    async def power_management_logic(self, os, location):
    ...
    async def memory_info_logic(self, os, location):
    ...
    async def baseboard_info_logic(self, os, location):
    ...
    async def check_configuration_space_logic(self, os, location):
    ...
    async def check_configuration_space_segment_logic(self, os, location):
    ...
    async def enumerate_device(self, request: Request) -> Response:
        os, location = await self.get_params(request)
        if location == 'target':
            result = await self.enumerate_device_logic(os, location)
    ...
    async def pci_description_filter(self, request: Request) -> Response:
        os, location = await self.get_params(request)
        if location == 'target':
            result = await self.pci_description_filter_logic(os, location)
            return make_json_response(result)
        return make_json_response({"error": "Endpoint applicable only for target location"})

    @exposed_http('GET', '/pci_check_driver_info')

    async def check_driver_info(self, request: Request) -> Response:
        os, location = await self.get_params(request)
        if location == 'target':
            result = await self.check_driver_info_logic(os, location)
            return make_json_response(result)
        return make_json_response({"error": "Endpoint applicable only for target location"})

    @exposed_http('GET', '/pci_error_handling')

    async def error_handling(self, request: Request) -> Response:
        os, location = await self.get_params(request)
        if location == 'target':
            result = await self.error_handling_logic(os, location)
            return make_json_response(result)
        return make_json_response({"error": "Endpoint applicable only for target location"})

    @exposed_http('GET', '/pci_power_management')
    async def power_management(self, request: Request) -> Response:
        os, location = await self.get_params(request)
        if location == 'target':
            result = await self.power_management_logic(os, location)
            return make_json_response(result)
        return make_json_response({"error": "Endpoint applicable only for target location"})

    @exposed_http('GET', '/pci_memory_info')

    async def memory_info(self, request: Request) -> Response:
        os, location = await self.get_params(request)
        if location == 'target':
            result = await self.memory_info_logic(os, location)
            return make_json_response(result)
        return make_json_response({"error": "Endpoint applicable only for target location"})

    @exposed_http('GET', '/pci_baseboard_info')

    async def baseboard_info(self, request: Request) -> Response:
        os, location = await self.get_params(request)
        if location == 'target':
            result = await self.baseboard_info_logic(os, location)
            return make_json_response(result)
        return make_json_response({"error": "Endpoint applicable only for target location"})

    @exposed_http('GET', '/pci_check_configuration_space')

    async def check_configuration_space(self, request: Request) -> Response:
        os, location = await self.get_params(request)
        if location == 'target':
            result = await self.check_configuration_space_logic(os, location)
            return make_json_response(result)
        return make_json_response({"error": "Endpoint applicable only for target location"})

    @exposed_http('GET','/pci_check_configuration_space_segment')

    async def check_configuration_space_segment(self, request: Request) -> Response:
        os, location = await self.get_params(request)
        if location == 'target':
            result = await self.check_configuration_space_segment_logic(os, location)
            return make_json_response(result)
        return make_json_response({"error": "Endpoint applicable only for target location"})
