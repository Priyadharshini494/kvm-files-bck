...
export function Session() {
	...
	var __hid4 = new Hid4(__streamer4.getResolution, __recorder);
	...
	var __wsMessageHandler = function(event) {
		...
		switch (data.event_type) {
			...
			case "streamer_state": __streamer.setState(data.event); __streamer2.setState(data.event); __streamer3.setState(data.event); __streamer4.setState(data.event);break;
