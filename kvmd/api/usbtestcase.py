...
class UsbApi:
    ...
    async def enumerate_usb_device_logic(self, os, location):
    ...
    async def usb_driver_information_logic(self, os, location):
    ...
    async def check_usb_device_info_logic(self, os, location):
    ...
    async def usb_error_handling_logic(self, os, location):
    ...
    async def usb_power_management_logic(self, os, location):
    ...
    async def enumerate_usb_device(self, request: Request) -> Response:
        ...
        if location == 'target':
            result = await self.enumerate_usb_device_logic(os, location)
    ...
    async def usb_driver_information(self, request: Request) -> Response:
        os, location = await self.get_params(request)
        if location == 'target':
            result = await self.usb_driver_information_logic(os, location)
            return make_json_response(result)
        return make_json_response({"error": "Endpoint applicable only for target location"})
    ...
    async def check_usb_device_info(self, request: Request) -> Response:
        os, location = await self.get_params(request)
        if location == 'target':
            result = await self.check_usb_device_info_logic(os, location)
            return make_json_response(result)
        return make_json_response({"error": "Endpoint applicable only for target location"})
    ...
    async def usb_error_handling(self, request: Request) -> Response:
        os, location = await self.get_params(request)
        if location == 'target':
            result = await self.usb_error_handling_logic(os, location)
            return make_json_response(result)
        return make_json_response({"error": "Endpoint applicable only for target location"})
    ...
    async def usb_power_management(self, request: Request) -> Response:
        os, location = await self.get_params(request)
        if location == 'target':
            result = await self.usb_power_management_logic(os, location)
            return make_json_response(result)
        return make_json_response({"error": "Endpoint applicable only for target location"})
