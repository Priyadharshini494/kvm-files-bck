...
#              return (await self._ws_loop(ws))
        ...
        "parameters": [
          {
            "name": "os",
            "in": "query",
            "description": "Operating system ('windows', 'linux', or 'edk')",
            "required": False,
            "schema": {
              "type": "string",
              "default": "windows"
    ...
    "/lan_adapter_status": {
      "get": {
        ...
        "responses": {
          "200": {
            "description": "Successfully retrieved LAN adapter status",
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",
    ...
    "/lan_ip_configuration": {
      "get": {
        ...
        "summary": "Retrieve LAN IP configuration",
        "parameters": [
          {
            "name": "os",
            "in": "query",
        ...
        "responses": {
          "200": {
            "description": "Successfully retrieved LAN IP configuration",
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",
    ...
    "/lan_static_ip_configuration": {
      "get": {
          "tags":[
            "LAN_Testcase"  
          ],
        "summary": "Set LAN static IP configuration",
        "parameters": [
          {
            "name": "os",
            "in": "query",
            "description": "Operating system ('edk')",
            "required": False,
            "schema": {
              "type": "string",
              "default": "edk"
        ...
        "responses": {
          "200": {
            "description": "Successfully configured static IP",
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",
    ...
    "/lan_ping": {
      "get": {
        ...
        "responses": {
          "200": {
            "description": "Successfully pinged target IP",
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",
          ...
          "400": {
            "description": "Invalid target IP or parameters provided"
          }
        }
      }
    }
