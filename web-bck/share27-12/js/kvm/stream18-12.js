...
export function Streamer() {
	...
	var __init__ = function() {
		__streamer = new _MjpegStreamer(__setActive, __setInactive, __setInfo);
                ...
                tools.el.setOnClick($("SimulationButton"), __clickSimulationButton);
	...
	self.getResolution = function() {
      ...
      var additionalOptions = document.getElementById('SimulationOption');
      additionalOptions.style.display = (additionalOptions.style.display === 'none') ? 'block' : 'none';
    };
